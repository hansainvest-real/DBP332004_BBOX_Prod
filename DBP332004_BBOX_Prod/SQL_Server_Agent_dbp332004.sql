...
/****** Object:  Job [BIS_ETL_startInterface_SAT]    Script Date: 07.05.2025 17:16:16 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 07.05.2025 17:16:16 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Clear SSIS - logging when older than one week]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Clear SSIS - logging when older than one week', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS-Package: Start HIRA SAP load for Import DB in box-schema]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS-Package: Start HIRA SAP load for Import DB in box-schema', 
		...
		@command=N'/ISSERVER "\"\SSISDB\HIRA\SAP_IMPORT\BISON.BOX_prod.dtsx\"" /SERVER DBP332004 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0, 
		@proxy_name=N'BIS_Proxy'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - BISimportDB]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'IndexOptimize - BISimportDB', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS package: SAP_Fill_BISimportDB]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS package: SAP_Fill_BISimportDB', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\SAP\SAP_Fill_BISimportDB.dtsx\"" /SERVER "\"DBP332004\"" /ENVREFERENCE 1 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Custom updates in BISimportDB]    Script Date: 07.05.2025 17:16:16 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS package: SAP_RE]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS package: SAP_RE', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\SAP\SAP_RE.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 1 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: BoBexchg]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: BoBexchg', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\bisonbox\BoBexchg_WebClient.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 4 /Par MyProxyPassword;"\"OFUCK?!r3lyt3ht\"" /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@output_file_name=N'C:\Temp\Log', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: BOBMM]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: BOBMM', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/FILE /CHECKPOINTING OFF /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Reset Lock]    Script Date: 07.05.2025 17:16:16 ******/
...
update dbo.bisintdata_lock set xdbLock = 0', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Custom updates in BISIBOBDB]    Script Date: 07.05.2025 17:16:16 ******/
...
exec BISIBOBDB.dbo.BIS_DltImmoObject @ObjList = @objL, @DltObj = 1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: ImmoInterface]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: ImmoInterface', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\bisonbox\immoInterface.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 4 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - packge: bobint]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - packge: bobint', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\bisonbox\BOBINT.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 4 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: SAP_FI]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: SAP_FI', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\SAP\SAP_FI.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 1 /Par AccountPrefix;HIRAsap /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: FIBU_KUM]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: FIBU_KUM', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/FILE "\"\\DBP332004\BISSQL\SSIS\bisonbox\FIBU_KUM.dtsx\"" /CHECKPOINTING OFF /SET "\"\Package.Variables[User::parServerName_SDB].Properties[Value]\"";DBP332004 /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: investor]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: investor', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/FILE "\"\\DBP332004\BISSQL\SSIS\bisonbox\investor.dtsx\"" /CHECKPOINTING OFF /SET "\"\Package.Variables[User::parServerName_SDB].Properties[Value]\"";DBP332004 /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update Statistics]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Update Statistics', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: reportBatch]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: reportBatch', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/ISSERVER "\"\SSISDB\CITSSIS\bisonbox\reportBatch.dtsx\"" /SERVER DBP332004 /ENVREFERENCE 4 /Par parBatchIdent;"\"ML_01\"" /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Call SSIS - package: cube]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Call SSIS - package: cube', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'SSIS', 
		@command=N'/FILE "\"\\DBP332004\BISSQL\SSIS\bisonbox\cube.dtsx\"" /CHECKPOINTING OFF /SET "\"\Package.Variables[User::parServerName_SDB].Properties[Value]\"";DBP332004 /REPORTING E', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CHCKMAINTJ - CommandLog]    Script Date: 07.05.2025 17:16:16 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'CHCKMAINTJ - CommandLog', 
	...
	RAISERROR(''Fehler im DB-Wartungsjob. Nähere Einzelheiten in der Protokolldatei BISDSYSDB.dbo.CommandLog.'',18,1)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CHCKMAINTJ - Prozesslog bereinigen]    Script Date: 07.05.2025 17:16:16 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily 21:00', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
